...
# add tir dataset here
__C.DATASET.NAMES = ('VID', 'COCO', 'DET', 'YOUTUBEBB', 'TIR')
...
# and here
__C.DATASET.TIR = CN()
__C.DATASET.TIR.ROOT = 'training_dataset/tir/crop511'
__C.DATASET.TIR.ANNO = 'training_dataset/tir/train.json'
__C.DATASET.TIR.FRAME_RANGE = 3
__C.DATASET.TIR.NUM_USE = -1
